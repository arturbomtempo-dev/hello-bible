...
<p align="center">
  <a href="https://marketplace.visualstudio.com/items?itemName=arturbomtempo-dev.hello-bible"><img src="https://vsmarketplacebadges.dev/version/arturbomtempo-dev.hello-bible.png?label=VS%20Code%20Marketplace&color=blue" alt="VS Code Marketplace Version" /></a>
  <a href="https://marketplace.visualstudio.com/items?itemName=arturbomtempo-dev.hello-bible"><img src="https://vsmarketplacebadges.dev/installs/arturbomtempo-dev.hello-bible.png?label=Installs" alt="Installs" /></a>
  <a href="https://marketplace.visualstudio.com/items?itemName=arturbomtempo-dev.hello-bible"><img src="https://vsmarketplacebadges.dev/rating-star/arturbomtempo-dev.hello-bible.png?label=Rating" alt="Rating" /></a>
